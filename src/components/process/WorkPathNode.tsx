...
import type { WorkStep } from "@/data/process";

interface WorkPathNodeProps {
  step: WorkStep;
  index: number;
  isLast: boolean;
}

export function WorkPathNode({ step, index, isLast }: WorkPathNodeProps) {
  return (
    <motion.div
    ...
    >
      ...
      {/* Description */}
      <p className="text-muted-foreground text-sm lg:text-base leading-relaxed max-w-[200px] lg:max-w-[300px]">
